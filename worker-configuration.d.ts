/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: ef01b002bb2b6adadacae98a8f4bf39b)
...
declare namespace Cloudflare {
	...
	interface Env {
		HELLO: "world";
		Foo: string;
		RUST_CONTAINER: DurableObjectNamespace<import("./worker/index").RustContainer>;
		ASSETS: Fetcher;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "HELLO" | "Foo">> {}
}
